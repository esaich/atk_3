...
return [
    ...
    /*
     * You can register your own checks here.
     */
    'checks' => [
        // Tambahkan pemeriksaan disk space untuk memantau penggunaan disk
        \Spatie\Health\Checks\Checks\UsedDiskSpaceCheck::new()
            ->warnWhenUsedSpaceIsAbovePercentage(70)
            ->failWhenUsedSpaceIsAbovePercentage(90),

        // Tambahkan pemeriksaan status database
        \Spatie\Health\Checks\Checks\DatabaseCheck::new(),

        // Tambahkan pemeriksaan keamanan untuk security advisories
    ...
    /*
     * The URL to the health dashboard.
     */
    'health_check_results_page' => [
        'middleware' => ['web'],
        'url' => '/health',
    ],
