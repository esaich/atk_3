...
<html>
<head>
    <title>Laporan Pengadaan Barang Supplier {{ $supplier->nama_supplier ?? 'N/A' }}</title>
    <style>
        body {
        ...
        .signature-box {
            ...
            border: 1px solid #ddd;
            padding: 10px;
            display: inline-block; /* Agar border bisa diterapkan */
        }
        .signature-line {
            margin-top: 60px;
        }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Untuk Supplier: {{ $supplier->nama_supplier ?? 'N/A' }}</h2>
        ...
        {{-- Bagian untuk tanda tangan menggunakan tabel agar posisi konsisten --}}
