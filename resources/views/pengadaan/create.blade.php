...
@section('title', 'Tambah Pengajuan Pengadaan Barang')

@section('content')
<div class="pagetitle">
    <h1>Tambah Pengajuan Pengadaan Barang</h1>
    <nav>
        <ol class="breadcrumb">
            ...
            <div class="card p-4">
                ...
                <form action="{{ route('pengadaan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_diajukan" id="jumlah_diajukan" class="form-control" min="1" value="{{ old('jumlah_diajukan') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="tanggal_pengajuan" class="form-label">Tanggal Pengajuan</label>
                        <input type="date" name="tanggal_pengajuan" id="tanggal_pengajuan" class="form-control" value="{{ old('tanggal_pengajuan', \Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                    </div>
